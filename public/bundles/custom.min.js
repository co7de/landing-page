    ...
    return {
        init: function() {
            ...
            jQuery("#menu").length > 0 && $("#menu").metisMenu(), jQuery(".metismenu > .mm-active ").each(function() {
                ...
                }), t(), jQuery("#datetimepicker1").length > 0 && $("#datetimepicker1").datetimepicker({
                    inline: !0
        ...
        load: function() {
            ...
            }, 800), jQuery(".default-select").length > 0 && jQuery(".default-select").selectpicker()
        },
        resize: function() {
            t()
        },
        handleMenuPosition: function() {
            e > 1024 && $(".metismenu  li").unbind().each(function(e) {
                if ($("ul", this).length > 0) {
                    ...
                    if (jQuery("html").hasClass("rtl")) var i = t + n <= a;
                    else i = t > 0;
...
jQuery(document).ready(function() {
    $('[data-bs-toggle="popover"]').popover(), Mediqu.init()
}), jQuery(window).on("load", function() {
    "use strict";
    Mediqu.load(), setTimeout(function() {
        Mediqu.handleMenuPosition()
    }, 1e3)
}), jQuery(window).on("resize", function() {
    "use strict";
    Mediqu.resize(), setTimeout(function() {
        Mediqu.handleMenuPosition()
    }, 1e3)
});